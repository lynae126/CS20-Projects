...
-----------------------------------
		  binaryTreeType
-----------------------------------
- copyTree(binaryTreeNode<elemType>*,
  binaryTreeNode<elemType>*) : void
- destroy(binaryTreeNode<elemType>*) : void
...
const binaryTreeType<elemType>& binaryTreeType<elemType>::operator=(const binaryTreeType<elemType>& otherTree){
    if (this != &otherTree){//avoid self-copy
        if (root)  //if the binary tree is not empty, destroy the binary tree
            destroy(root);
        if (!otherTree.root) //otherTree is empty
            root = nullptr;
        else
