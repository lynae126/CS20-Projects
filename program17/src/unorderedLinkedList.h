...
-----------------------------------
		unorderedLinkedList
-----------------------------------
+ search(const Type& searchItem) const : bool
...
//search(): searches for node with given element
//Arguments:searchItem (const Type&) | Returns: found(bool)
template <class Type>
...
//insertFirst():  inserts item into first place
//Arguments: newItem (const Type&) | Returns: void
template <class Type>
...
//insertLast(): inserts item into last place
//Arguments: newItem (const Type&) | Returns: void
template <class Type>
...
//deleteNode(): deletes node with given item
//Arguments: deleteItem(const Type&)| Returns: void
template <class Type>
