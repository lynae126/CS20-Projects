	...
	while(choice != 9){
		switch(choice){
			...
			case 6:
				...
				break;
			case 7:
				cout << "Videos rented out: \n";
				custList.rentedVideosInfo(id);
				break;
			case 8:
				cout << "Logging out...\n\n";
				processRequests(videoList, custList);
